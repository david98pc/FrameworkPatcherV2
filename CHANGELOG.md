...
- **GitHub Issues**: [Report bugs or request features](https://github.com/FrameworksForge/FrameworkPatcher/issues)
...
[View all releases on GitHub](https://github.com/FrameworksForge/FrameworkPatcher/releases)
