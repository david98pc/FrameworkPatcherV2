...
create_module() {
    ...
    if [ -f "$module_prop" ]; then
        ...
        sed -i "s/^description=.*/description=Framework patcher compatible with Magisk, KernelSU (KSU), and SUFS. Patched using frameworksforge.github.io\/FrameworkPatcher/" "$module_prop"
